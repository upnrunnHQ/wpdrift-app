          ...
          <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="card">
              <div class="card-header">
                <div class="float-left">Update Site</div>
              ...
              <div class="card-body">
                <form method="post" action="{{ route('sites.update',[$store->id]) }}" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                      <label class="col-md-4 col-form-label text-md-right" for="select-company">Company
                      </label>
                      <div class="col-md-6">
                        <a href="/settings/companies/{{ $stores_company->id }}">{{ $stores_company->name }}</a></label>
