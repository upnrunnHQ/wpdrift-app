        ...
        <div class="spark-screen container">
            <div class="row">
                ...
                <div class="col-md-3 spark-settings-tabs">
                    <aside>
                        ...
                        <ul class="nav flex-column mb-4 ">
                            @if (!$dashboard_access)
                            <li class="nav-item ">
                                <a class="nav-link" href="#site" aria-controls="site" role="tab" data-toggle="tab">
                                    <svg class="icon-20 " viewBox="0 0 20 20 " xmlns="http://www.w3.org/2000/svg ">
                                        <path d="M4,18 L4,2 L12,2 L12,6 L16,6 L16,18 L4,18 Z M2,19 L2,0 L3,0 L12,0 L14,0 L18,4 L18,6 L18,20 L17,20 L2,20 L2,19 Z"></path>
                                    </svg>
                                    {{__('Site')}}
                                </a>
                            </li>
              ...
              18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
                            ...
                            @if (Spark::usesTeams() && $dashboard_access)
                                <li class="nav-item ">
              ...
              6.7V17h2v-2.3c.6-.3 1-1 1-1.7 0-1-1-2-2-2s-2 1-2 2c0 .7.4 1.4 1 1.7zM6 6v2h6V6c0-1.7-1.3-3-3-3S6 4.3 6 6z "
                            ...
                            @if (Spark::usesApi() && $dashboard_access)
                                <li class="nav-item ">
              ...
              1-2 2-2h4V2c0-1 1-2 2-2s2 1 2 2v2h4c1 0 2 1 2 2v4h-2c-1 0-2 1-2 2s1 2 2 2h2z "/>
                    ...
                    <!-- Billing Tabs -->
                    @if (Spark::canBillCustomers() && $dashboard_access)
                        <aside>
                            <h3 class="nav-heading ">
                                {{__('Billing')}}
                            </h3>
              ...
              1 .5 1 1v1zm1 18c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2zm10 0c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2z " />
                ...
                <div class="col-md-9">
                    <div class="tab-content">
                        <!-- Site -->
                        @if (! $dashboard_access)
                        <div role="tabcard" class="tab-pane" id="site">
                            @include('spark::settings.site')
                        </div>
                        @endif
