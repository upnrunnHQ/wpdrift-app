...
class ProcessSyncDiscountMeta extends Job
{
    ...
    protected function save_edd_database()
    {
        ...
        try {
            ...
            $deleted_edd_discounts_metas = DiscountMeta::where('store_id', $this->store_id)
            ...
            \Log::info('Successfully Added Discount Meta for ID:'.$this->post_id);
        } catch (\Exception $e) {
            $error = $e->getMessage();
            \Log::error($error);
