...
class CreateEddlogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eddlogs', function (Blueprint $table) {
            ...
            $table->foreign(['store_id', 'ID'])->references(['store_id', 'post_id'])->on('customers_metas');
            $table->timestamps();
        });
    }
